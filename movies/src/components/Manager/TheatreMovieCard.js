...
import { deleteTheatreMovie } from '../../api-helpers/api-helpers';

const TheatreMoviesCard = ({title,releaseDate,posterurl,id, t_id}) => {
...
export default TheatreMoviesCard